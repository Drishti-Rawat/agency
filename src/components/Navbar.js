  ...
  return (
    <section className='bg-black/45  w-full fixed top-0 z-50 p-4 '>
        <div className='max-w-5xl mx-auto  flex justify-between items-center'>
            {/* logo */}
            <Link href={'/'} className='uppercase font-extrabold tracking-tighter text-2xl  text-white'>Agence.</Link>

            <nav className='text-white flex gap-11 text-sm '>
                <Link href={''} className='uppercase'>Home</Link>
                <Link href={''} className='uppercase'>About us</Link>
                <Link href={''} className='uppercase'>Pages</Link>
                <Link href={''} className='uppercase'>Blog</Link>
            ...
            <nav className='flex  gap-7 items-center'>
                ...
                <Link href={''}><Facebook className='bg-white rounded-full p-0.5 ' color='white' fill='black' stroke='24' size={20}/></Link>
                <Link href={''}><Twitter fill='white' color='white' size={20}/> </Link>
                <Link href={''}>
...
<Link href={''}><Instagram color='white'  size={20}/> </Link>
<Link href={''}><Search color='white'  size={20}/> </Link>
