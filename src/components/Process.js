...
const Process = () => {
  return (
    <section className="relative w-full min-h-[80vh] bg-gray-100 flex flex-col items-center justify-center overflow-hidden py-16 px-4">
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-start justify-center gap-5 md:gap-4   lg:gap-24  mt-8 sm:mt-12 ">
        <div className="">
          <ProcessInfoCard IconBgcolor="bg-primary" number="01" />
        </div>
        <div className="mt-0 sm:mt-14">
          <ProcessInfoCard IconBgcolor="bg-blue-950" number="02" />
        </div>
        <div>
          <ProcessInfoCard IconBgcolor="bg-primary" number="03" />
        </div>
      </div>
    </section>
  );
